...
- (void)buildNavUI
{
    ...
    imageView.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 44);
    ...
    Done.frame = CGRectMake([UIScreen mainScreen].bounds.size.width - 70, 0, 50, 44);
...
{
    [self.navigationController dismissViewControllerAnimated:YES completion:nil];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"alertUploadSuccess" object:nil];
}
