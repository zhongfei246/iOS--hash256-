...
- (void)BuildUIWithType:(FMVideoViewType)type
{
    ...
    self.topView.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 44);
    [self addSubview:self.topView];
    
    self.timeView = [[UIView alloc] init];
    self.timeView.hidden = YES;
    self.timeView.frame = CGRectMake(([UIScreen mainScreen].bounds.size.width - 100)/2, 16, 100, 34);
    ...
    self.cancelBtn.frame = CGRectMake(15, 0, 44, 44);
    [self.cancelBtn setImage:[UIImage imageNamed:@"cancel"] forState:UIControlStateNormal];
    self.cancelBtn.imageView.contentMode =  UIViewContentModeCenter;
    ...
    self.turnCamera.frame = CGRectMake([UIScreen mainScreen].bounds.size.width - 60 - 44, 0, 44, 44);
    [self.turnCamera setImage:[UIImage imageNamed:@"listing_camera_lens"] forState:UIControlStateNormal];
    self.turnCamera.imageView.contentMode =  UIViewContentModeCenter;
    ...
    self.flashBtn.frame = CGRectMake([UIScreen mainScreen].bounds.size.width - 44 - 15, 0, 44, 44);
    [self.flashBtn setImage:[UIImage imageNamed:@"listing_flash_off"] forState:UIControlStateNormal];
    self.flashBtn.imageView.contentMode =  UIViewContentModeCenter;
    ...
    self.progressView = [[FMRecordProgressView alloc] initWithFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width - 62)/2, [UIScreen mainScreen].bounds.size.height - 32 - 62, 62, 62)];
